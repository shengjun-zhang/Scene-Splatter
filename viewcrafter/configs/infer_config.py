...
def get_parser():
    ...
    ## diffusion
    parser.add_argument("--ckpt_path", type=str, default='./viewcrafter/checkpoints/model.ckpt', help="checkpoint path")
    parser.add_argument("--config", type=str, default='./viewcrafter/configs/inference_pvd_1024.yaml', help="config (yaml) path")
    ...
    ## dust3r
    parser.add_argument('--model_path', type=str, default='./viewcrafter/checkpoints/DUSt3R_ViTLarge_BaseDecoder_512_dpt.pth', help='The path of the model')
